...
if __name__ == "__main__":
    ...
    fig1.add_trace(go.Scatter3d(name= 'X', mode = 'markers', x=X[:,0], 
        y=X[:,1], z=X[:,2], marker=dict(color='rgb(256,0,0)', size=1)))
    fig1.add_trace(go.Scatter3d(name= 'Y',mode = 'markers', x=Y[:,0], 
    ...
    fig = go.Figure()
    # uncomment to see the original point cloud as well
